...
<body>
  <div>
    ...
    // sort
    echo '<b>sort: clasificaci�n por valor, claves no conservadas</b><br />';
    $matriz_bis = $matriz;
    sort($matriz_bis);
    ...
    // asort
    echo '<b>asort: clasificaci�n por valor, claves conservadas</b><br />';
    $matriz_bis = $matriz;
    asort($matriz_bis);
    foreach ($matriz_bis as $clave => $valor) {
      echo "$clave => $valor<br />";
    ...
    // ksort
    echo '<b>ksort: clasificaci�n por clave, claves conservadas</b><br />';
    $matriz_bis = $matriz;
    ksort($matriz_bis);
    foreach ($matriz_bis as $clave => $valor) {
      echo "$clave => $valor<br />";
    ...
    echo '<b>Clasificaci�n por defecto (alfab�tica):</b><br />';
    $matriz_bis = $matriz;
    sort($matriz_bis);
    foreach ($matriz_bis as $valor) {
      echo "$valor<br />";
    }
    // Clasificaci�n natural
    echo '<b>Clasificaci�n natural:</b><br />';
    $matriz_bis = $matriz;
    ...
    echo '<b>Con el par�metro "l�mite"</b><br />';
    ...
    $textos = array_column($art�culos, 'texto');
    foreach ($textos as $clave => $valor) {
      echo "[$clave] = $valor<br>";
    }
    echo '<b>Columna de precios utilizando el texto como �ndice:</b><br />';
    $precio = array_column($art�culos, 'precio', 'texto');
