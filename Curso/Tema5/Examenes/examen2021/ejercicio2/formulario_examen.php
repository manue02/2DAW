...
<body>
    ...
    <form name="altas" method="POST" action="proceso_insercion.php">
        <table bgcolor="#E9FFFF" align=center border=2>
            ...
            <td align="left"> <input type="text" name="dni" value="" size=8></td>
            <tr>
                <td align="right">Nombre....: </td>
                <td align="left"> <input type="text" name="nombre" value="" size=20></td>
            <tr>

                <td align="right">Apellido....: </td>
                <td align="left"> <input type="text" name="apellido" value="" size=20></td>
            <tr>
                <!-- opcion radio para fumador o no fumador-->
                <td align="right">Fumador:</td>
                <td align="left"> <input type="radio" name="fumador" value="1" checked> Si <input type="radio"
                        name="fumador" value="0"> No </td>
            <tr>
                <!-- Sexo-->
                <td align="right">Sexo:</td>
                <td align="left"> <input type="radio" name="sexo" value="1" checked> Hombre <input type="radio"
                        name="sexo" value="0"> Mujer </td>
            <tr>
