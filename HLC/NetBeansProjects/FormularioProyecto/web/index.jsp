    ...
    <html>
        ...
        <body>
            ...
            <p>Introduce tu direccion de email: 
                ...
                <h:selectOneRadio value="#{datos.decision}" layout="pageDirection">
            ...
            <p>
                <h:selectOneListbox value="#{datos.plataforma}">
                    <f:selectItems value="#{datos.listaPlataforma}"/>
                </h:selectOneListbox>
            ...
            <p>
                <h:selectManyListbox value="#{datos.vidiojuegos}">
                    <f:selectItems value="#{datos.listaVidiojuegos}"/>
                </h:selectManyListbox>
                
            </p>
            
             <p>Selecciona su genero o generos favoritos:<br>
                    <h:selectManyCheckbox value="#{datos.genero}">
