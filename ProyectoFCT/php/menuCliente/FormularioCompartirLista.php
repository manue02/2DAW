...
<body id="page-top">
            ...
            <div class="navbar-collapse collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    <li class="nav-item"><a class="nav-link me-lg-3"
                            ...
                            Reservas</a></li>
                    <li class="nav-item"><a class="nav-link me-lg-3"
                            href="ClasesDisponibles.php?usuario=<?php echo $usuario; ?>">Clases
                            Disponibles</a>
                    </li>
    ...
    <form id="frmAsingnacionProfesor" action="../consultasClientes/ConsultaCompartir.php" method="post"
        enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">
        <div class="row">
            <h1 class="col-7">Compartir clases con otro usuario</h1>
        </div>
        ...
        echo "<input type='text' placeholder='Email' autocomplete='no' name='EmailEmisor' id='EmailEmisor'  readonly='readonly' value='$email'>"
            ?>
        <input type="text" placeholder="Email del usuario para compartir" autocomplete="no" id="EmailReceptor"
            name="EmailReceptor">

        <input class="buttonClassRegistrar" type="submit" id="AsingnacionProfesor" value="Compartir clases">
    </form>
