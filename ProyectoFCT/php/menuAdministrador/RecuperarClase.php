...
<body id="page-top">
    ...
    <form id="frmRecuperarClase" enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">
        <h1>Recuperar una Clase</h1>
        <input type="text" placeholder="Nombre" autocomplete="no" id="NombreRecuperarClase" name="NombreRecuperarClase">
        <input class="buttonClassRegistrar" type="submit" id="recuperarClase" value="Recuperar">
    </form>
