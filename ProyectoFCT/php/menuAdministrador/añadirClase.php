...
<body id="page-top">
    ...
    <form id="frmAñadirClase" enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">
        <div id="focus"></div>
        <h1>Añadir una Clase</h1>
        <input type="text" half placeholder="Nombre" autocomplete="no" name="Nombre" id="name">
        <input type="text" half placeholder="descripcion" autocomplete="no" name="descripcion" id="description">
