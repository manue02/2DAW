...
<body id="page-top">
    ...
    <form id="frmAsingnacionProfesor" action="../menuAdministrador/listaDeClases.php" method="post"
        enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">
        <div class="row">
            <h1 class="col-7">Clases de un profesor</h1>
        </div>
        <input type="hidden" id="id_profesor" name="id_profesor">
        <input type="text" placeholder="Usuario" autocomplete="no" id="Email" name="Email">
        <input class="buttonClassRegistrar" type="submit" id="AsingnacionProfesor" value="Visualizar">
    </form>
