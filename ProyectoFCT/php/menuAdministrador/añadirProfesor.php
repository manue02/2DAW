...
<body id="page-top">
    ...
    <form id="frmRegistroProfesor" enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">
        <div class="row">
            <h1 class="col-7">Asignar un profesor</h1>
        </div>
        ...
        <input type="text" placeholder="Clase" autocomplete="no" id="Clase" name="Clase">
        <input class="buttonClassRegistrar" type="submit" id="registrarNuevoProfesor" value="Registrar">
    </form>
