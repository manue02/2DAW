...
<body id="page-top">
    ...
    <form id="frmRecuperarUsuario" enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">

        <h1>Recuperar Usuario</h1>
        <input type="text" placeholder="Email" autocomplete="no" id="recuperarEmail" name="EmailUsuarioRecuperar">
        <input class="buttonClassRegistrar" type="submit" id="RecuperarUser" value="Recuperar">
    </form>
