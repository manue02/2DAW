...
<body id="page-top">
    ...
    <form id="frmAsignarUnaClase" enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">
        <div class="row">
            <h1 class="col-7">Asignar Horario</h1>
        </div>
        <input type="text" placeholder="Email" autocomplete="no" id="Email" name="Email">
        <input type="time" half placeholder="Entrada" autocomplete="no" id="Entrada" name="Entrada">
        <input type="time" half placeholder="Salida" autocomplete="no" id="Salida" name="Salida">
        <input type="text" placeholder="Clase" autocomplete="off" id="Clase" name="Clase" class="ui-autocomplete-input">
        <input class="buttonClassRegistrar" type="submit" id="asignarUnaClase" value="Añadir">
    </form>
