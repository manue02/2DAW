...
<body id="page-top">
    ...
    <form id="frmEliminarUsuario" enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">

        <h1>Eliminar Usuario</h1>
        <input type="text" placeholder="Email" autocomplete="no" id="Email" name="EmailUsuario">
        <input class="buttonClassOtraBja" type="submit" id="eliminarUser" value="Dar de baja">
    </form>
