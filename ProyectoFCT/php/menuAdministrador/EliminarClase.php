...
<body id="page-top">
    ...
    <form id="frmDarDeBaja" enctype="multipart/form-data" class="Customform container-fluid" autocomplete="off">
        <h1>Dar de Baja una Clase</h1>
        <input type="text" placeholder="Nombre" autocomplete="off" id="name" name="Nombre"
            class="ui-autocomplete-input">
        <span class="palta">Fecha Baja</span>
        <input type="date" half class="fecha" autocomplete="no" readonly name="fecha_baja" id="DateBaja">
        <input type="file" id="foto" name="subirFoto">
        <input class="buttonClassBaja" type="submit" id="DarDeBaja" value="Dar de Baja">
    </form>
